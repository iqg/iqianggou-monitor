 ...
 * @Route("/analyse/api/hsq")
 */
class HsqAnalyseController extends Controller
{
    /**
     * Uri list of Analyse statistics
     *
     * @Route("/",name="dwd_tongji_analyse_hsq_dashboard")
     */
    public function indexAction(Request $request)
    {
        ...
        $oal = $mongoConn->selectCollection('hsq_internal_api_data');
     ...
     *
     * @Route("/urichart",name="dwd_tongji_analyse_hsq_dashboard_urichart")
     */
