...
/**
 * Class HsqAppOfflineAnalyseController
 * @package DWD\TongjiBundle\Controller
 * @Route("/analyse/api/hsq_app_offline")
 */
class HsqAppOfflineAnalyseController extends Controller
{
    public $_mongodb_origin  = 'hsq_app_offline_data';
    /**
     * Uri list of Analyse statistics
     *
     * @Route("/",name="dwd_tongji_analyse_hsq_app_offline_dashboard")
     */
    public function indexAction(Request $request)
    {
        ...
        return $this->render('DWDTongjiBundle:Analyse:app_offline_list.html.twig', array(
            'apiList'       => $apiList,
            'sumCall'       => $sumCall,
            'title'         => date('Y-m-d', $startTimestamp) . ' API访问',
            'startTimestamp' => $startTimestamp,
            'subject'       => 'tongji_analyse_hsq_app_offline',
            'project'       => 'hsq_app_offline',
        ));
    }
     ...
     *
     * @Route("/urichart",name="dwd_tongji_analyse_hsq_app_offline_dashboard_urichart")
     */
