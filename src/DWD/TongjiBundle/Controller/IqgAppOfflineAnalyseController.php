...
/**
 * Class IqgAppOfflineAnalyseController
 * @package DWD\TongjiBundle\Controller
 * @Route("/analyse/api/iqg_app_offline")
 */
class IqgAppOfflineAnalyseController extends Controller
{
    public $_mongodb_origin  = 'iqg_app_offline_data';
    /**
     * Uri list of Analyse statistics
     *
     * @Route("/",name="dwd_tongji_analyse_iqg_app_offline_dashboard")
     */
     ...
     *
     * @Route("/urichart",name="dwd_tongji_analyse_iqg_app_offline_dashboard_urichart")
     */
